...
typedef BYTE virt_STBL_SetEcho(BOOL Val);  
...
virt_STBL_SetEcho                   *pt_STBL_SetEcho ;                  //(BOOL Val);
...
STBLLIB_API BYTE STBL_ERASE(BYTE NbSectors, LPBYTE pSectors)
{
	if(pt_STBL_ERASE)
...
/*   Disabled  = FALSE
/************************************************************************************/
STBLLIB_API BYTE STBL_SetEcho(BOOL val)
{
